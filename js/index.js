...
// [/] Task 1: Create new selectors using DOM Element Methods
// [/] Task 2: NO direct updating of the HTML source
// [/] Task 3: Update the SRC attributes on Img
// [/] Task 4: Change Nav text color to Green
// [/] Task 5: Utilize .appendChild() and .prepend() to add two new items to the Nav system.
...
// Add Two new items to the Nav System - Use .apprendChild() and .prepend() // 
...
selectedNavLinks.prepend(createNewNode("Lambda School"));
selectedNavLinks.append(createNewNode("Warranty"));
